// Quiz Implementation Logic
// This code implements a simple quiz about urban flooding, allowing users to answer questions and see their score at the end.
...
const quizData = [
  ...
  },
  {
    ...
    options: ["Poluição sonora e má alimentação", "Contaminação e doenças"],
    correct: 1,
  },
  {
    question: "Como a vegetação ajuda a evitar enchentes?",
    options: [
  ...
  },
  {
    ...
    options: ["Observar o nível da água pela janela", "Andar em ruas alagadas"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["Transbordam quando chove demais", "Servem como esgoto natural"],
    correct: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      "Aumento no nível das águas que invadem áreas urbanas",
      "Tremor de terra seguido de chuva",
    ],
    correct: 0,
  },
  {
